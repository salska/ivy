...
export function migrate(db: Database): void {
  ...
  // SQLite PRAGMA foreign_keys cannot be changed within a transaction.
  // We must disable them globally before running migrations so that
  // DROP TABLE statements succeed even when parent tables are referenced.
