...
import { logCredentialAccess, logCredentialDenied } from '../src/runtime/credential/audit.ts';
import { loadScopeConfig, isCredentialAllowed } from '../src/runtime/credential/scope.ts';
import type { CredentialScopeConfig } from '../src/runtime/credential/types.ts';
